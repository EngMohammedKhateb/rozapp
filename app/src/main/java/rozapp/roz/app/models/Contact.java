...
public class Contact implements Serializable {
    ...
    public Contact(int id, String name, String type, int coins, String online, int coinsPerMinute, String image, String statue) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.coins = coins;
    ...
    public Contact(int id, String name, String type, int coins, String online, int coinsPerMinute, int disableChat, int disableVideo, String image, String statue) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.coins = coins;
